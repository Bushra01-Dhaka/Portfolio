...
const Contact = () => {
  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen lg:p-20 p-6 bg-linear-to-r from-black to-[#B4E50D]">
      <div
        data-aos="zoom-up"
        data-aos-offset="200"
        data-aos-delay="100"
        data-aos-duration="1000"
        className="p-10 lg:p-20 bg-black rounded-2xl shadow-lg shadow-primary"
      >
